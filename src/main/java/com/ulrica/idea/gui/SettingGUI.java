...
public class SettingGUI {
    ...
    public String getExportDirsAbsolute() {
        Project currentProject = ProjectUtil.getCurrentProject();
        String basePath = currentProject.getBasePath();
        return basePath + "/" + exportDirs.getText();
    }
    ...
    public String getListenDirs() {
        return this.listenDirs.getText();
    }

    public void setListenDirs(JTextField listenDirs) {
    ...
    public void setExportDirs(JTextArea exportDirs) {
